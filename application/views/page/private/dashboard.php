										...
										<div class="direct-chat-messages">
											...
											<div class="direct-chat-msg">
												...
												<div class="direct-chat-text">
													Is this user really for free? That's unbelievable!
												</div>
												<!-- /.direct-chat-text -->
											</div>
											<!-- /.direct-chat-msg -->
											...
											<ul class="contacts-list">
												...
												<li>
													<a href="#">
														<img
															class="contacts-list-img"
															src="<?= base_url('assets/adminlte/') ?>dist/img/user7-128x128.jpg"
															alt="User Avatar"
														/>
												...
												<li>
													<a href="#">
														<img
															class="contacts-list-img"
															src="<?= base_url('assets/adminlte/') ?>dist/img/user5-128x128.jpg"
															alt="User Avatar"
														/>
												...
												<li>
													<a href="#">
														<img
															class="contacts-list-img"
															src="<?= base_url('assets/adminlte/') ?>dist/img/user6-128x128.jpg"
															alt="User Avatar"
														/>
